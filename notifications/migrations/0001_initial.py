    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type',       models.CharField(choices=[('like','Like'),('comment','Comment'),('message','Message'),('system','System'),('job','Job'),('housing','Housing'),('attorney','Attorney'),('event','Event')], default='system', max_length=20)),
